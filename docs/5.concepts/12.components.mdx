...
<details>
<summary>Example in the Messenger platform</summary>
...
<details>
<summary>Example in the Messenger App</summary>
...
<details>
<summary>Example of the media types</summary>
...
This is how it looks for the recipient:
...
<details>
<summary>In this case, this template generates a nice boarding pass.</summary>
...
<div style={{display:"flex", justifyContent:"space-between"}}>
  <PrevButton title="Botonic Settings" href="/concepts/botonic-settings" />
  <NextButton title="Human Handoff" href="/concepts/humanhandoff" />
</div>