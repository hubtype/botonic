...
```javascript
<>
	<Imgage src='https://botonic.io/images/botonic_react_logo-p-500.png'/>
...
export default class extends React.Component {
  ...
  render() {
    ...
    return(
      <Text>
        I am a share button!
        <ShareButton payload={my_share_button}></ShareButton>
      </Text>
    ) 
  }
}
  ...
  render() {
    ...
    return(
      <Text>
        ...
        <MessageTemplate payload={my_message_template}></MessageTemplate>
      </Text>          
    ) 
  }
}
