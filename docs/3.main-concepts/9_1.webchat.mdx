      ...
      document.addEventListener('DOMContentLoaded', function(event) {
        Botonic.render(document.getElementById('root'), {
          appId: 'YOUR_APP_ID',
          	...
          	onClose: app => console.log('Webchat closedd!'),
...
but since it's based on React, you can let your imagination run free to achieve great results by creating your own components from scratch! Check [Webchat's customization section](/tutorials-and-examples/custom-webchat) for further details.
