...
route: /templates/template-dynamic-carousel
menu: Templates
---
...
<div style={{display:"flex", justifyContent:"space-between"}}>
  <PrevButton title="Childs" href="/templates/childs" />
  <NextButton title="Human Handoff" href="/templates/template-human-handoff" />
</div>