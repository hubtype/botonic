---
name: Human Handoff
route: /templates/template-human-handoff
menu: 6. Templates
---
...
<div style={{display:"flex", justifyContent:"space-between"}}>
  <PrevButton title="Dynamic Carousel" href="/templates/template-dynamic-carousel" />
  <NextButton title="Natural Language Understanding" href="/templates/template-nlu" />
</div>