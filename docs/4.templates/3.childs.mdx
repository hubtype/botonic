...
<div style={{display:"flex", justifyContent:"space-between"}}>
  <PrevButton title="Custom Webchat" href="/templates/template-custom-webchat" />
  <NextButton title="Dynamic Carousel" href="/templates/template-dynamic-carousel" />
</div>