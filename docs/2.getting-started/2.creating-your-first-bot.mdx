...
>
>Followed by: `npm install @botonic/nlu @botonic/plugin-nlu `
...
To create an intent, simply add a new text file under `src/nlu/utterances/eng/`, for example `src/nlu/utterances/eng/Greetings.txt`.
