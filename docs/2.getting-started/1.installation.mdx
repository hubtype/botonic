...
This will install a few dependencies just to have the CLI available. It might take a while, so please be patient. If you encounter any problems please report them [here](https://github.com/hubtype/botonic/issues). You can ask as well your questions at [Slack](http://botonic.slack.com). Alternatively, you can also use [yarn](https://yarnpkg.com/lang/en/), as a Node Package Manager.
...
To run your bot, `cd` into the directory that was created and then run the `botonic serve` command to test your bot right in your browser!
