...
So in this example, we have added three different intents which our bot will know how to understand. Obviously, the more example utterances you have, the better results you will obtain.

### **Defining your entities**
You can also define your entities in the same utterances as follows:
...
`Place` is a generic entity as well as `Person`, `Organization` or `Date`, this is how you can access them with the input object:
...
Sometimes, you will need to capture more specific entites which you can define as this:  

"Show me the way to Rand's birthday party by `[car](Vehicle)`"  

which you can access in `input.entities.tags`, that is a list containing all the tagged words by the algorithm.
