...
This is the main file of the webchat config. In this file, we export all the options that are going to be changed from the default webchat config.

These are the options that Botonic allows you to modify:
