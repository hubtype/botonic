...
export const webchat = {
  theme: {
    ...
    /*
     * brand.image will set both header.image and message.bot.image with its current logo
    ...
    scrollbar: {
      ...
      thumb: {
        ...
        color: 'yellow', 
        bgcolor:
          'linear-gradient(-131deg,rgba(231, 176, 43) 0%,rgb(193, 62, 81) 100%);', // has preference over color
        border: '20px' 
      }
      // track: {
      //   color: 'black', 
      //   bgcolor:
      //     'linear-gradient(-131deg,rgba(50, 40, 43) 0%,rgb(125, 62, 81) 100%);', // has preference over color
      //   border: '20px'
      // }
    }
}
