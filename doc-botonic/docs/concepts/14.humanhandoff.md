...
|--------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|---------|------|
| `withQueue`        | ID or name of the queue where the conversation is transferred.                                                      | queueNameOrId | string  | Yes  |
| `withOnFinishPath` | Specify a payload or a path to trigger the action that the bot will follow after the conversation with the agent has finished. | path          | string  | Yes  |
| `withAgentEmail`   | Agent's email.                                                                                                      | email         | string  | Yes  |
| `withAgentId`      | Agent's ID.                                                                                                         | agentId       | string  | Yes  |
| `withNote`         | Leave a message for other agents to know more about the case.                                                                  | note          | string  | Yes  |
| `withCaseInfo`     | Give details about the case.                                                                                                   | caseInfo      | string  | Yes  |
| `withShadowing`    | Hidie agent's ID and name.                                                                                                  | shadowing     | boolean | No   |
...
|----------|--------|-------------------|
| queues   | string[] | Names of the queues |
...
| Property | Type   | Description       |
|----------|--------|-------------------|
| agents   | string[] | Names of the agents |
