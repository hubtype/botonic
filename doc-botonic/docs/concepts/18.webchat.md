...
- `openCoverComponent`: Opens an authentication window.
- `closeCoverComponent`: Closes the authentication window.
- `toggleCoverComponent`: Opens or closes the authentication window depending on the current state.
