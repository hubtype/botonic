...
The Cover component enables the user to authenticate when starting the conversation. In that way, you can retrieve relevant information at the very beginning of the interaction, such as the user's name or e-mail address.
...
- A message from the user saying **START** is displayed and the action with a **PAYLOAD** is called.