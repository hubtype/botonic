...
3. Add plugins to transform some new functionalities from ES6 to ES5 compliant. For example: [the arrow functions](https://www.npmjs.com/package/@babel/plugin-transform-arrow-functions)
