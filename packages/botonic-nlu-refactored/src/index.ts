...
// import { UTTERANCES_DIRNAME, NLU_DIRNAME, MODELS_DIRNAME } from './constants';
...
//   const resultsPath = join(process.cwd(), 'tests', NLU_DIRNAME, MODELS_DIRNAME);
//   await trainer.save(resultsPath);
// })();
