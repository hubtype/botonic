import type { OutputMessage, ResolvedPlugins } from '@botonic/core'
...
import { parseToolsExecuted } from '../tools/parse-tools-executed'
import type {
  AgenticInputMessage,
...
> {
  ...
  protected getToolsExecuted(
    ...
    return parseToolsExecuted(result.newItems ?? [], context)
  }
