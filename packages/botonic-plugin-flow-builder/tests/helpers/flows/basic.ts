...
export const basicFlow = {
  ...
  "published_by": null,
  "published_on": null,
  "hash": "ec055e17bc4fbaaa74d4a46699602840696e7886",
  "default_locale_code": "en",
  "locales": [
      "en"
  ],
  "translated_locales": [],
  "start_node_id": "0196c963-c409-7457-87b3-5a88f78611fa",
  "ai_model_id": null,
  ...
  "nodes": [
      ...
      },
      {
          ...
          "content": {
              "text": [
                  {
                      "message": "This is the message that is displayed if the value is not defined or is none of the others",
                      "locale": "en"
                  }
              ],
              "buttons_style": "button",
      ...
      },
      {
          ...
          "content": {
              "text": [
                  {
                      "message": "This text message contains buttons and replaces the variable {bagsAdded}",
                      "locale": "en"
                  }
              ],
              "buttons_style": "button",
      ...
      {
          "id": "0196c963-c409-7457-87b3-5a88f78611fa",
          "code": "FIRST_INTERACTION_CONDITIONAL",
          "is_code_ai_generated": false,
          "meta": {
              "x": 257.55156674513637,
              "y": -119.39419833993722
          },
          "follow_up": null,
          "target": null,
          "flow_id": "8d527e7d-ea6d-5422-b810-5b4c8be7657b",
              ...
              "arguments": [
                  {
                      "type": "boolean",
                      "name": "keyPath",
                      "value": "session.is_first_interaction"
                  }
              ],
              "result_mapping": [
                  {
                      "result": "default",
                      "target": {
                          "id": "0196c963-f1bc-7004-af08-adf81fb27760",
                          "type": "text"
                      }
                  },
                  {
      ...
      },
      {
          ...
          "content": {
              ...
              "keywords": [
                  {
                      "values": [
                          "anyVariableForBooleanCondition"
                      ],
                      "locale": "en"
                  }
              ]
