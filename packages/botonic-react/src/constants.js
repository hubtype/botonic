...
export const WEBCHAT = {
  ...
  CUSTOM_PROPERTIES: {
    ...
    userMessageRightPadding: 'message.user.rightPadding',
    ...
    triggerButtonHoverOpacity: 'triggerButton.hoverOpacity',
    triggerButtonHoverColor: 'triggerButton.hoverColor',
    triggerButtonStyle: 'triggerButton.style',
    triggerButtonStyleOpacity: 'triggerButton.style.opacity',
    triggerButtonStyleBackground: 'triggerButton.style.background',
